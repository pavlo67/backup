...
//func (eps Config) Join(joinerOp joiner.Operator) error {
//	for i, ep := range eps {
//		if err := joinerOp.Join(&eps[i], ep.InterfaceKey); err != nil {
//			return errors.CommonError(err, fmt.Sprintf("can't join %#v as Endpoint with key '%s'", ep, ep.InterfaceKey))
//		}
//	}
//
//	return nil
