...
//}
//
//func FragmentsView(fields []viewshtml.Field, data map[string]string, options map[string]viewshtml.SelectString, frontOps map[string]viewshtml.Operator) string {
//	if data == nil {
...
//
//func FragmentsEdit(user *auth.User, fields []viewshtml.Field, data map[string]string, options map[string]viewshtml.SelectString, frontOps map[string]viewshtml.Operator, rView auth.ID, publicChanges bool) string {
//	formNum++
