...
var listPage = server_http.EndpointPage{
	...
	WorkerHTTPPage: func(serverOp server_http.OperatorV2, req *http.Request, params server_http.PathParams, identity *auth.Identity) (server_http.ResponsePage, error) {
		...
		filesItems, err := filesOp.List(path, depth)
		if err != nil {
			return server_http.ErrorPage(0, err, "при filesOp.List()", req)
		}
...
var deletePage = server_http.EndpointPage{
	...
	WorkerHTTPPage: func(serverOp server_http.OperatorV2, req *http.Request, params server_http.PathParams, identity *auth.Identity) (server_http.ResponsePage, error) {
		path := params["path"]
		if err := filesOp.Remove(path); err != nil {
			return server_http.ErrorPage(0, err, "при filesOp.Remove()", req)
		}
...
//	},
//	WorkerHTTPPage: func(serverOp server_http.OperatorV2, req *http.Request, params server_http.PathParams, identity *auth.Identity) (server_http.ResponsePage, error) {
//		r, err := filesOp.Read(path)
//		if err != nil {
//			return server_http.ErrorPage(0, err, "при filesOp.ReadWithChildren()", req)
//		}
//
...
//		if err != nil {
//			return server_http.ErrorPage(0, err, "при filesOp.Read()", req)
//		}
//
...
//		if err != nil {
//			return server_http.ErrorPage(0, err, "при filesOp.Save()", req)
//		} else if r.ID == "" {
//			return server_http.ErrorPage(0, fmt.Errorf("on filesOp.Save(%#v, %#v): got nil", *r, identity), "при filesOp.Save()", req)
//		}
//
