...
func (recordsOp *recordsSQLite) List(*selectors.Term, *auth.Identity) ([]records.Item, error) {
	return nil, common.ErrNotImplemented
...
func (recordsOp *recordsSQLite) Tags(*selectors.Term, *auth.Identity) (tags.StatMap, error) {
	return nil, common.ErrNotImplemented
